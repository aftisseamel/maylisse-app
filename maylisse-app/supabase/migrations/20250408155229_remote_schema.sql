...
COMMENT ON TABLE "public"."deliveryman" IS 'table pour caractériser les livreurs';



ALTER TABLE "public"."deliveryman" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE "public"."deliveryman" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."deliveryman" TO "anon";
GRANT ALL ON TABLE "public"."deliveryman" TO "authenticated";
GRANT ALL ON TABLE "public"."deliveryman" TO "service_role";
